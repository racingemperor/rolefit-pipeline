...
def build_tasks(invocations: list[dict[str, Any]], terms: list[str]) -> list[dict[str, Any]]:
    ...
    tasks = [
        ...
        task(
            "company-bound-hr-real-questions",
            "hr-supervisor" if "hr-supervisor" in agents else default_agent,
            "company_bound_hr_real_question",
            "verified_hr_public_post",
            2,
            f"{query} target company verified HR public interview resume screening questions",
            True,
            False,
            "medium",
            "cache_metadata_and_short_excerpt",
        ...
        | {
            ...
            "user_instruction_required": False,
            "display_sources": display_sources_by_type["verified_hr_public_post"],
            "company_binding_required": True,
            "not_model_generated_required": True,
            "output_fields": [
            ...
            "degrade_rule": "If no target/recommended company HR public wording is found, return unavailable and research tasks; do not generate HR wording yourself.",
        },
        task(
